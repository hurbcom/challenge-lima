...
Uma vez ligados, cada drone deverá receber uma lista de comandos, em formato de string, que deverá ser executada sequencialmente e a cada comando executado uma foto 360º é tirada. Os comandos possíveis são: (D)ireita, (E)squerda, (F)rente. Ex: "DFFEEFDFE" Nesse exemplo vão ser tiradas 5 fotos.
